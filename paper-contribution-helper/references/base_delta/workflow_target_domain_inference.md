...
Use when initialization needs focus domains but the user prefers to upload the paper they want to reframe.
...
2. Deep-read the paper, including method, setting, assumptions, experiments, keywords, related-work positioning, and claimed contribution.
